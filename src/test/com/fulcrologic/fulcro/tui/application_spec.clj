...
(specification {:covers {`app/application      "0c544b,b2bfe4"
                         `app/attach!          "d47881,1dc5b6"
                         `app/render!          "35406a,4e7f05"
...
(specification {:covers {`app/step! "6b509b,3c2166"}} "step! — focus, typing, and activation"
...
(specification {:covers {`app/render!          "35406a,4e7f05"
                         `app/too-small-buffer "6bd38f,0c57c0"}} "render! — diff path & resize"
...
(specification {:covers {`app/step!         "6b509b,3c2166"
...
(specification {:covers {`app/mount!        "9db704,8f330a"
                         `app/run-blocking! "ecfe25,36f036"
...
(specification {:covers {`app/render! "35406a,4e7f05"
                         `app/step!   "6b509b,3c2166"}} "overlay compositing & focus trap"
...
(specification {:covers {`app/start! "f91686,87ab1e"}} "start! — build + run in one call"
...
(specification {:covers {`app/request-render! "92aa4b,77fd1a"}} "request-render! — throttle + coalescing"
