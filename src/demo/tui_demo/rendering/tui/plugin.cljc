(ns tui-demo.rendering.tui.plugin
  ...
  (:require
    ...
    ;;  * tui-demo.rendering.tui.form registers the form `render-element` defmethods (0.1.5 form
    ;;    structural rendering is defmethod-based, not controls-map-based).
    [com.fulcrologic.rad.report]
    [com.fulcrologic.rad.form]
    [tui-demo.rendering.tui.field :as field]
    [tui-demo.rendering.tui.form]
    [tui-demo.rendering.tui.report :as report]))
...
(def all-controls
  "The fulcro-tui RAD control set. Install with `rad-application/install-ui-controls!` before mounting.
   ...
   `tui-demo.rendering.tui.form`, per the 0.1.5 contract, not via this map.)"
  {;; ── Report renderers ──────────────────────────────────────────────────────
